...
public final class CommandSetUser extends Command implements Serializable {
    ...
    public CommandSetUser()
    {
        super("setuser", 10, "<setting> <name> <value>", "Change the setting of a user", true);
    }
